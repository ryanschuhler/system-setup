...
#   ------------------------------------------------------------
    ...
    export PATH="/usr/local/git/bin:/sw/bin/:/usr/local/bin:/usr/local/:/usr/local/sbin:/usr/local/mysql/bin:$HOME/.nodebrew/current/bin:$PATH"
...
#   ------------------------------
    # Apache Ant
    export ANT_HOME="$HOME/Library/apache-ant-1.9.12"
...
alias driteb='docker run -it --entrypoint bash'

alias g='git'
alias glsy='git ls | yank'
...
alias setJava10='export JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk-10.0.1.jdk/Contents/Home'
alias ebp='vim ~/.bash_profile'
alias sbp='source ~/.bash_profile'
alias scratch='vim ~/Documents/scratch.txt'
findPid () { lsof -t -c "$@" ; }   # Note that the command name can be specified via a regex
